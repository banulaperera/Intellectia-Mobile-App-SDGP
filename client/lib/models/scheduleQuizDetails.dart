class ScheduleQuizDetail{
  ...
  ScheduleQuizDetail({this.id,required this.preferredModuleName,required this.preferredTime, required this.preferredFrequency});
  ...
  factory ScheduleQuizDetail.fromJson(Map<String,dynamic> json){
    return ScheduleQuizDetail(
        ...
        preferredTime:DateTime.parse(json['preferredTime'] as String).toLocal(),
