...
exports.addNote=async (req,res)=>{
    try {
        ...
        res.status(200).json({ Message: "The Note Successfully Added"})
    }catch (error){
...
exports.deleteNote=async (req,res)=>{
    try {
        ...
        res.status(200).json({Message: "The Note Successfully Deleted"})
    }catch (error){
        res.status(400).json({ Message: "The request is not completed "})
    }
}
...
exports.updateNote=async (req,res)=>{
    try {
        ...
        res.status(200).json({Message: "The Note Successfully updated"})
    }catch (error){
        console.log(error)
        res.status(400).json({ Message: "The request is not completed "})
    }
